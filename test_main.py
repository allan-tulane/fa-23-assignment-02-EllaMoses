...
def test_multiply():
    ...
    assert subquadratic_multiply(BinaryNumber(2), BinaryNumber(1)) == 2*1
    assert subquadratic_multiply(BinaryNumber(-10), BinaryNumber(2)) == -10*2
    assert subquadratic_multiply(BinaryNumber(-10), BinaryNumber(-2)) == -10*-2
    assert subquadratic_multiply(BinaryNumber(-10), BinaryNumber(0)) == -10*0
    ...
    assert subquadratic_multiply(BinaryNumber(6), BinaryNumber(21)) == 6*21
    assert subquadratic_multiply(BinaryNumber(15), BinaryNumber(13)) == 15*13
